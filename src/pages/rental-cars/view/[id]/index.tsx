...
import { getRentalCarById } from 'apiSdk/rental-cars';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Rental Car Detail View
          </Text>
          {hasAccess('rental_car', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/rental-cars/edit/${data?.id}`} passHref legacyBehavior>
              <Button
